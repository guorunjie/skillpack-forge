# Skillpack MCP Server: test-automation-demo
...
{
  "mcpServers": {
    "test-automation-demo-skillpack": {
      "command": "node",
...
If your MCP client supports `test-automation-demo-skillpack.mcpb` installation, use the bundle path from the packaging step instead of wiring the stdio server manually.
...
```bash
skillpack-forge mcpb . test-automation-demo-skillpack.mcpb
```
