# Skillpack MCP Server: ops-runbook-demo
...
If your MCP client supports `ops-runbook-demo-skillpack.mcpb` installation, use the bundle path from the packaging step instead of wiring the stdio server manually.
...
```bash
skillpack-forge mcpb . ops-runbook-demo-skillpack.mcpb
```
