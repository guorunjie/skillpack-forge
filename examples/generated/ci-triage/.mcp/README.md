# Skillpack MCP Server: ci-triage-demo
...
If your MCP client supports `ci-triage-demo-skillpack.mcpb` installation, use the bundle path from the packaging step instead of wiring the stdio server manually.
...
```bash
skillpack-forge mcpb . ci-triage-demo-skillpack.mcpb
```
