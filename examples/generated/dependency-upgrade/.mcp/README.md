# Skillpack MCP Server: dependency-upgrade-demo
...
{
  "mcpServers": {
    "dependency-upgrade-demo-skillpack": {
      "command": "node",
...
If your MCP client supports `dependency-upgrade-demo-skillpack.mcpb` installation, use the bundle path from the packaging step instead of wiring the stdio server manually.
...
```bash
skillpack-forge mcpb . dependency-upgrade-demo-skillpack.mcpb
```
