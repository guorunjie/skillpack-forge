...
If your MCP client supports `docs-ops-demo-skillpack.mcpb` installation, use the bundle path from the packaging step instead of wiring the stdio server manually.
