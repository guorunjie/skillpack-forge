# Skillpack MCP Server: data-automation-demo
...
{
  "mcpServers": {
    "data-automation-demo-skillpack": {
      "command": "node",
...
If your MCP client supports `data-automation-demo-skillpack.mcpb` installation, use the bundle path from the packaging step instead of wiring the stdio server manually.
...
```bash
skillpack-forge mcpb . data-automation-demo-skillpack.mcpb
```
