# Skillpack MCP Server: release-ops-demo
...
If your MCP client supports `release-ops-demo-skillpack.mcpb` installation, use the bundle path from the packaging step instead of wiring the stdio server manually.
...
```bash
skillpack-forge mcpb . release-ops-demo-skillpack.mcpb
```
