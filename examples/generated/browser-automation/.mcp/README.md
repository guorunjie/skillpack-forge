# Skillpack MCP Server: browser-ops-demo
...
If your MCP client supports `browser-ops-demo-skillpack.mcpb` installation, use the bundle path from the packaging step instead of wiring the stdio server manually.
...
```bash
skillpack-forge mcpb . browser-ops-demo-skillpack.mcpb
```
