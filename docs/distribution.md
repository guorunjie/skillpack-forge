...
The automation skillpack gallery gives new users concrete starting points for browser automation, Playwright, test automation, CI triage, dependency upgrades, docs, release, ops, data automation, and data pipeline workflows.
...
- `github/awesome-copilot`: [PR #1905](https://github.com/github/awesome-copilot/pull/1905) opened for a Skillpack Forge custom instruction that teaches Copilot to create, compile, verify, and package portable agent context. Added a reviewer proof comment with npm and live fixture links: https://github.com/github/awesome-copilot/pull/1905#issuecomment-4609079763.
- `ComposioHQ/awesome-claude-skills`: [PR #996](https://github.com/ComposioHQ/awesome-claude-skills/pull/996) opened for a Claude Skill that guides agents through Skillpack Forge workflows. Added a reviewer proof comment with npm and live fixture links: https://github.com/ComposioHQ/awesome-claude-skills/pull/996#issuecomment-4609079760.
- `rohitg00/awesome-claude-code-toolkit`: [PR #484](https://github.com/rohitg00/awesome-claude-code-toolkit/pull/484) opened for the Claude Code toolkit list. Added a reviewer proof comment with npm and live fixture links: https://github.com/rohitg00/awesome-claude-code-toolkit/pull/484#issuecomment-4609079741.
