...
The automation skillpack gallery gives new users concrete starting points for browser automation, Playwright, test automation, CI triage, docs, release, ops, data automation, and data pipeline workflows.
