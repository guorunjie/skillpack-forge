...
- Dependency upgrade template for reviewing outdated packages, applying safe updates, and verifying compatibility.
...
- generated automation, browser automation, Playwright, test automation, CI triage, dependency upgrade, release, docs, ops, data automation, and data pipeline examples under `examples/generated`.
